  ...
  public Module jsonMapperJava8DateTimeModule() {
    ...
    module.addSerializer(LocalDateTime.class, new JsonSerializer<LocalDateTime>() {
      ...
      public void serialize(
          ...
          throws IOException {
        jsonGenerator
            .writeString(DateTimeFormatter.ofPattern("yyyy-MM-dd kk:mm:ss").format(localDateTime));
      }
    });
    module.addDeserializer(LocalDate.class, new JsonDeserializer<LocalDate>() {
      ...
      public LocalDate deserialize(JsonParser jsonParser,
        ...
        return LocalDate
            .parse(jsonParser.getValueAsString(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
      }
    });
    module.addDeserializer(LocalTime.class, new JsonDeserializer<LocalTime>() {
      ...
      public LocalTime deserialize(JsonParser jsonParser,
          DeserializationContext deserializationContext) throws IOException {
        return LocalTime
            .parse(jsonParser.getValueAsString(), DateTimeFormatter.ofPattern("kk:mm:ss"));
      }
    });
